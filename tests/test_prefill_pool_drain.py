...
"""O dreno do pool do MLX no meio de um preparo longo — opt-in, porque medido não resolveu.
...
def test_desligado_de_fabrica(monkeypatch):
    """Medido em 05/09: 259 drenos deixaram o processo só ~1 GB mais baixo e as pausas ficaram."""
    chamadas = []
